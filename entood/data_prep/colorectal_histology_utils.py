...
def load_images(take=None):
    datasets, ds_info = tfds.load('ColorectalHistology', data_dir='image_classification.ColorectalHistology',
...
def load_data():
    datasets = tfds.load('ColorectalHistology', data_dir='image_classification.ColorectalHistology',
